...
public class MainChessClass {								//	AlphaBetaChess

	static String[][] chessBoard = {
			{"r","k","b","q","a","b","k","r"},//Black		//////////////////////////
			{"p","p","p","p","p","p","p","p"},//Black		//	1 - a/A = King		//
			{" "," "," "," "," "," "," "," "},				//	1 - q/Q = Queen		//
			{" "," "," "," "," "," "," "," "},				//	2 - r/R = Rooks		//
			{" "," "," "," "," "," "," "," "},				//	2 - k/K = Knights	//
			{" "," "," "," "," "," "," "," "},				//	2 - b/B = Bishops	//
			{"P","P","P","P","P","P","P","P"},//White		//	8 - p/P = Pawns		//
			{"R","K","B","Q","A","B","K","R"},//White		//////////////////////////
	};
	static int kingPositionC, kingPositionL;	// C = Capital = A , L = Lower = a
	...
	public static void main(String[] args) {
		...
		/*
		 * (1234b represent row1,column2 moves to row3, column4 which captured b (a space represent no capture))
		 */
		...
		if(humanAsWhite == 0) {
			...
			makeMove(alphaBetaPruning(globalDepth, 1000000, -1000000, "", 0));
	...
	public static String alphaBetaPruning(int depth, int beta, int alpha, String move, int player) {
		...
		for(int i = 0; i < list.length(); i+=5){
			...
			flipBoard();
			String returnString = alphaBetaPruning(depth - 1, beta, alpha, list.substring(i, i+5), player);
	...
	public static String posibleP(int i) {	//Pawn
	...
	public static String posibleR(int i) {	//Rook
		String list = "", oldPiece;
		int temp = 1, r = i/8, c = i%8;
		for(int j = -1; j <= 1; j+=2) {
			try {
	...
	public static String posibleK(int i) {	//Knight
		String list = "", oldPiece;
		int r = (i/8), c = (i%8);
		for(int j = -1; j <= 1; j+=2) {
			for(int k = -1; k <= 1; k+=2) {
				try {
					if((Character.isLowerCase(chessBoard[r + j][c + (2 * k)].charAt(0))) || 
							(" ".equals(chessBoard[r + j][c + (2 * k)]))) {
	...
	public static String posibleB(int i) {	//Bishop
		String list = "", oldPiece;
		int r = (i/8), c = (i%8);
		int temp = 1;
		for(int j = -1; j <= 1; j+=2) {
	...
	public static String posibleQ(int i) {	//Queen
		String list = "", oldPiece;
		int r = (i/8), c = (i%8);
		int temp = 1;
		for(int j = -1; j <= 1; j++) {
	...
	public static String posibleA(int i) {	//King
		String list = "", oldPiece;
		int r = (i/8), c = (i%8);
		for(int j = 0; j < 9; j++) {
			if(j != 4) {
	...
	public static boolean kingSafe() {//is the king in any danger?
		//bishop/queen
		int temp = 1;
		for(int i = -1; i <= 1; i+=2) {
			for(int j = -1; j <= 1; j+=2) {
